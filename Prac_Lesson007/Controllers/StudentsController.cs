...
using Prac_Lesson007.ViewModels;

namespace Prac_Lesson007.Controllers
{
        ...
        public async Task<IActionResult> Index()
        {
            var students = await _context.Students
                ...
                .Select(s => new StudentViewModel
                {
                    ...
                    Age = s.Age,
                    Class = s.Class,
                    CourseName = s.Course != null ? s.Course.Name : "No Course",
                    CourseDescription = s.Course != null ? s.Course.Description : ""
                })
                .ToListAsync();
